...
import com.noriyuki.workshopmongo.dto.CredentialsDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            CredentialsDTO credentialsDTO = new ObjectMapper().readValue(request.getInputStream(), CredentialsDTO.class);   // Instancia um credDTO a partir dos dados que vieram na requisição
            ...
            Authentication authentication = authenticationManager.authenticate(authToken);  // Faz validação de usuario e senha utilizando os contratos
